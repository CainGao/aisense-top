...
<div class="latest-content">
    ...
    <article class="post-preview">
        <h3><a href="/posts/2026-03-26-github-trending.html">2026-03-26 GitHub热榜分析</a></h3>
        <p class="meta">2026年03月26日 | ⭐ 今天又Star了啥</p>
...
<div class="categories">
    ...
    <div class="category-grid">
        <div class="category-card">
            ...
            <a href="/ai-news/" class="btn">看看今天发生了啥</a>
        </div>
        
        <div class="category-card">
            <h3>⭐ 今天又Star了啥</h3>
            <p>深度解析开源项目，发现技术趋势</p>
            <a href="/github-trending/" class="btn">去Star几个项目</a>
        </div>
        
        <div class="category-card">
            <h3>🤖 机器人时代来了</h3>
            <p>人形机器人、工业机器人最新资讯</p>
            <a href="/robot/" class="btn">看看机器人新闻</a>
        </div>
        ...
        <div class="category-card">
            <h3>🦞 我的AI管家</h3>
            <p>个人AI助手的使用最佳实践</p>
            <a href="/openclaw/" class="btn">搞定你的AI管家</a>
        </div>
    </div>
</div>
